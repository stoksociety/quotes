...
var form_component_component_1 = require("./form-component/form-component.component");
var quote_component_1 = require("./quote/quote.component");
var quote_form_component_1 = require("./quote-form/quote-form.component");
var quote_vote_component_1 = require("./quote-vote/quote-vote.component");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                form_component_component_1.FormComponentComponent,
                quote_component_1.QuoteComponent,
                quote_form_component_1.QuoteFormComponent,
                quote_vote_component_1.QuoteVoteComponent
            ],
            imports: [
